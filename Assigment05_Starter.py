...
strItem = ""
strValue = ""
# objFile = open("ToDoList.txt", "w") to create file
...
for row in objFile:
    lstRow = row.split(",")
    dicRow = {"Item": lstRow[0], "Description": lstRow[1].strip()}
...
while (True):
    ...
    # Step 4 - Add a new item to the list/Table
        ...
        # TODO: Add Code Here
        strItem = input("Item: ")
        strValue = input("Description: ")
        dicRow = {"Item": strItem, "Description": strValue}
        lstTable.append(dicRow)
        continue
    ...
    # Step 6 - Save tasks to the ToDoToDoList.txt file
        ...
        for dicRow in lstTable:
            objFile.write(str(dicRow["Item"]) + "," + str(dicRow["Description"]) + "\n")
        objFile.close()
